                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-20">
                                        ...
                                        <textarea class="form-control radius-8 @error('description.en') is-invalid @enderror" id="description"
                                            placeholder="Enter Description" name="description[en]">{{ old('description.en', $service->getTranslation('description', 'en')) }}</textarea>
                                    ...
                                    <div class="col-md-6 mb-20">
                                        ...
                                        <textarea class="form-control radius-8 @error('description.ar') is-invalid @enderror" id="description_ar"
                                            placeholder="Enter Description" name="description[ar]">{{ old('description.ar', $service->getTranslation('description', 'ar')) }}</textarea>
                                    ...
                                    <div class="col-md-6 mb-20">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('keywords.en', $service->getTranslation('keywords', 'en')) }}">
                                        @error('keywords.en')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-20">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('keywords.ar', $service->getTranslation('keywords', 'ar')) }}">
                                        @error('keywords.ar')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                        ...
                                        <div class="card h-100 p-0">
                                            ...
                                            <div class="card-body p-24">
                                                <div class="upload-image-wrapper d-flex align-items-center gap-3">
                                                    <div
                                                        class="uploaded-img position-relative h-120-px w-120-px border input-form-light radius-8 overflow-hidden border-dashed bg-neutral-50 {{ $service->hasMedia('services') ? '' : 'd-none' }}">
                                                        <button type="button"
                                                        ...
                                                        <img id="uploaded-img__preview" class="w-100 h-100 object-fit-cover"
                                                            src="{{ $service->getFirstMediaUrl('services') ?: asset('assets/images/user.png') }}"
                                                            alt="image">
                                                    </div>
