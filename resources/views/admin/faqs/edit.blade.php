                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-20">
                                        ...
                                        <textarea class="form-control radius-8 @error('question.en') is-invalid @enderror" id="question"
                                            placeholder="Enter Question" name="question[en]">{{ old('question.en', $faq->getTranslation('question.en')) }}</textarea>
                                        @error('question.en')
                                    ...
                                    <div class="col-md-6 mb-20">
                                        ...
                                        <textarea class="form-control radius-8 @error('question.ar') is-invalid @enderror" id="question_ar"
                                            placeholder="Enter Question" name="question[ar]">{{ old('question.ar', $faq->getTranslation('question.ar')) }}</textarea>
                                        @error('question.ar')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-20">
                                        ...
                                        <textarea class="form-control radius-8 @error('answer.en') is-invalid @enderror" id="answer"
                                            placeholder="Enter Answer" name="answer[en]">{{ old('answer.en', $faq->getTranslation('answer.en')) }}</textarea>
                                        @error('answer.en')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-20">
                                        ...
                                        <textarea class="form-control radius-8 @error('answer.ar') is-invalid @enderror" id="answer_ar"
                                            placeholder="Enter Answer" name="answer[ar]">{{ old('answer.ar', $faq->getTranslation('answer.ar')) }}</textarea>
                                        @error('answer.ar')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
